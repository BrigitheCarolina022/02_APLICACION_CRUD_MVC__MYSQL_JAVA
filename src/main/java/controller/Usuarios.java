...
/*private void login (HttpServletRequest req, HttpServletResponse resp) {
        //guardamos los datos del input en variables 

        String inpnombre_Usua = req.getParameter("nombre");
        String inpcontraseña = req.getParameter("contrasena");
        
        String nombre_Usua = r.getNombre_Usua();
        int  contrasena = r.getContraseña_Usua();
        ...
        try {
           if((inpnombre_Usua == nombre_Usua) && (inpcontraseña == contrasena)){
            System.out.println("Ingreso correctamente");
        }
        }catch (Exception e) {
            System.out.println("Error en el login del usuario" + e.getMessage().toString());
}
