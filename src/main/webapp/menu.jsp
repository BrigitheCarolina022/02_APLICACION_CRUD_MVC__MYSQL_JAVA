			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
						<a class="nav-link" href="Usuarios?accion=listar">Usuarios</a>
					</li>
					<li class="nav-item active">
						<a class="nav-link" href="Usuarios?accion=Daviplataa">Daviplata</a>
					</li>
					<li class="nav-item active">
						<a class="nav-link" href="Usuarios?accion=Nequii">Nequi</a>
					</li>
                    <li class="nav-item active">
...
<center>
        <footer><P>
		 ...
		 <b> Copyright &popy; 2023 - BOGOTA D.C</b> </P>	
</center>
		 </footer>
        </body>
          </html>
